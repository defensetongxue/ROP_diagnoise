...
def get_config():
    ...
    parser.add_argument('--split_name', type=str, default="mini", help='Where the data generate')
    ...
    parser.add_argument('--generate_ridge_segment', type=bool, default=True, help='if parse orginal ridge annotation data')
